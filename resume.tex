...
\contact {Rex Oliver}{(803)$-$622$-$7187}{rexroao@g.clemson.edu}{622 Chimney Hill Road Columbia, SC 29209}
...
\beginninglist {Softdocs} {Software Development Intern} {Summer 2019-Present} {Columbia, SC} \vspace{-8pt}
\begin{itemize}
	\item I currently work on an Agile Team in front-end development of the Form Builder application. This work is primarily done in in JavaScript and HTML.  \vspace{-5pt}
	\item I also worked with the DevOps team using C\# to repair a failing build system. \vspace{-5pt}
\end{itemize}	
\beginninglist {Clemson University School of Computing} {Student Ambassador} {Spring 2019-Present} {Clemson, SC} \vspace{-8pt}
\begin{itemize}
	\item Host prospective students and their families on tours and provide a thorough introduction to the school, degree programs, facilities, and research labs.\vspace{-5pt}
	\item Led tour groups of up to 90 people with a presentation and walk-through of the School of Computing. \vspace{-5pt}
\end{itemize}	
\beginninglist {DXC Technology} {Automation Intern} {Summer of 2018} {Blythewood, SC} \vspace{-8pt}
\begin{itemize}
...
\beginninglist {Eureka! Clemson Research Program} {Research Student} {Summer of 2017} {Clemson, SC}
\vspace{-8pt}
\begin{itemize}
...
\end{itemize}
\beginninglist {Dietary Equipment Company and Jewel Manufacturing} {Laborer} {Summers of 2014, 2015, and 2016} {Columbia, SC} \vspace{-8pt}
\begin{itemize}
...
\item SCISA All-State Varsity Soccer \hfill \hfill Spring 2017 \vspace{-5pt}
\end{itemize}
