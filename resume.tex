...
\begin{itemize}
	\item Worked on an Agile Team in front-end development of the Form Builder application. Primarily developed new features to Form Builder in JavaScript using the Knockout.js and Aurelia frameworks. \vspace{-5pt}
